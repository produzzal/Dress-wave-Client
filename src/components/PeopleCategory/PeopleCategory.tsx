...
const PeopleCategory = () => {
  return (
    <div className="flex flex-col md:flex-row justify-between mt-3 md:my-7">
      {/* Left Menu */}
      ...
      {/* Right Banner */}
      <div className="w-full md:w-1/2 bg-gray-100  text-white text-center py-3 px-4 md:py-6 md:px-10">
